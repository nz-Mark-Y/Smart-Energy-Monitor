A wireless energy monitor. Includes analogue design, VHDL architecture, microcontroller C programming, and Python for the smart energy challenge. See the separate repo for the android app.
